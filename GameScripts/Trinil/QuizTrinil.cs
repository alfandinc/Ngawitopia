...
public class QuizTrinil : MonoBehaviour
{
    // UI elements
    ...
    private string[] questions = {
        "Patung hewan apa yang menjadi ikon museum Trinil?",
        "Siapa yang menemukan Pithecanthropus Erectus di Ngawi?",
        "Berapa jumlah koleksi museum Trinil menurut situs Kemendikbud?",
        // Add more questions as needed
    };

    private string[][] options = {
        new string[] {"Gajah", "Orangutan", "Burung Merak", "Simpanse"},
        new string[] {"Neil Amstrong", "Eugene Dubois", "Charles Xavier", "Antony Santos"},
        new string[] {"9", "20", "15", "12"},
        // Add more options arrays corresponding to each question
    };

    private int[] correctAnswers = {0, 1, 3}; // Index of correct answers for each question
    ...
    void SelectAnswer(int optionIndex)
    {
        ...
        {
            PlayerPrefs.SetInt("TitleTrinil", 1); // Set title claim status
