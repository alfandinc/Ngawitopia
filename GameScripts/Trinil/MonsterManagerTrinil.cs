...
public class MonsterManagerTrinil : MonoBehaviour
{
    ...
    public UIManagerTrinil uiManager;
    ...
    void UpdateCapturedMonsterCount()
    {
        ...
        PlayerPrefs.SetInt("TotalCapturedTrinil", totalCaptured); // Save the updated count
