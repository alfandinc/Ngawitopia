...
public class MonsterManagerTawun : MonoBehaviour
{
    ...
    public UIManagerTawun uiManager;
    ...
    void UpdateCapturedMonsterCount()
    {
        ...
        PlayerPrefs.SetInt("TotalCapturedTawun", totalCaptured); // Save the updated count
