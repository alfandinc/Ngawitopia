...
public class UIManagerTawun : MonoBehaviour
{
    //audio
    ...
    public MonsterManagerTawun monstermanager;
    ...
    {
        int totalCaptured = PlayerPrefs.GetInt("TotalCapturedTawun", 0); // Get the current total captured count
...
//Quizmath
    ...
    public void ShowMonsterInfo(MonsterManagerTawun monster)
    {
        AudioManager.Instance.PlaySFX(buttonClickSFX);
...
//scene
    ...
    public void LoadBossTawunScene()
    {
        AudioManager.Instance.PlaySFX(buttonClickSFX);
        AudioManager.Instance.ResumeBGM();
        SceneManager.LoadScene("BossTawunDialogue");
    }
