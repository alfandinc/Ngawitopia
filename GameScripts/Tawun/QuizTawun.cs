...
public class QuizTawun : MonoBehaviour
{
    // UI elements
    ...
    private string[] questions = {
        "Hewan apa yang menjadi icon Tawun?",
        "Upacara apa yang dilakukan di Tawun?",
        "Apa nama event di Tawun yang diadakan setiap Ahad Legi?",
        // Add more questions as needed
    };

    private string[][] options = {
        new string[] {"Kura-kura", "Ikan Mas", "Kupu-kupu", "Bulus"},
        new string[] {"Ngaben", "Keduk Beji", "Siraman", "Kembang Tawun"},
        new string[] {"Pasar Legi", "Pasar Kejawen", "Pasar Gulo", "Pasar Jadoel"},
        // Add more options arrays corresponding to each question
    };

    private int[] correctAnswers = {3, 1, 3}; // Index of correct answers for each question
    ...
    void SelectAnswer(int optionIndex)
    {
        ...
        {
            PlayerPrefs.SetInt("TitleTawun", 1); // Set title claim status
