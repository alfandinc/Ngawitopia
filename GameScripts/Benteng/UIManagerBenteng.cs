...
public class UIManagerBenteng : MonoBehaviour
{
    //audio
    ...
    public MonsterManagerBenteng monstermanager;
    ...
    {
        int totalCaptured = PlayerPrefs.GetInt("TotalCapturedBenteng", 0); // Get the current total captured count
...
//Quizmath
    ...
    public void ShowMonsterInfo(MonsterManagerBenteng monster)
    {
        AudioManager.Instance.PlaySFX(buttonClickSFX);
...
//scene
    ...
    public void LoadBossBentengScene()
    {
        AudioManager.Instance.PlaySFX(buttonClickSFX);
        AudioManager.Instance.ResumeBGM();
        SceneManager.LoadScene("BossBentengDialogue");
    }
