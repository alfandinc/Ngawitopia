...
public class MonsterManagerBenteng : MonoBehaviour
{
    ...
    public UIManagerBenteng uiManager;
    ...
    void UpdateCapturedMonsterCount()
    {
        ...
        PlayerPrefs.SetInt("TotalCapturedBenteng", totalCaptured); // Save the updated count
