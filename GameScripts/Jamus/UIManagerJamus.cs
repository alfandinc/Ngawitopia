...
public class UIManagerJamus : MonoBehaviour
{
    //audio
    ...
    public MonsterManagerJamus monstermanager;
...
//Quizmath
    ...
    public void ShowMonsterInfo(MonsterManagerJamus monster)
    {
        AudioManager.Instance.PlaySFX(buttonClickSFX);
...
//scene
    ...
    public void LoadBossJamusScene()
    {
        AudioManager.Instance.PlaySFX(buttonClickSFX);
        AudioManager.Instance.ResumeBGM();
        SceneManager.LoadScene("BossJamusDialogue");
    }
